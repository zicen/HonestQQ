 ...
 */
public class PluginFragment extends BaseFragment implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private String CenterUrls[] = {"http://qqgame.qq.com/","https://www.zhihu.com/","http://www.ikandian.com/","http://book.qq.com/","http://ac.qq.com/",
            "http://music.163.com/","http://www.qqlubo.net/"};
    private String FootUrls[] = {"http://www.baihe.com/betatest/betatest_newlandpage.html",
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.ib_weather:
                ...
                break;
            case map:
                mIntent.putExtra(Constant.URL,"http://map.baidu.com/");
