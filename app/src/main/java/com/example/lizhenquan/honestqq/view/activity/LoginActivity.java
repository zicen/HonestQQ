...
public class LoginActivity extends BaseActivity implements LoginView, TextView.OnEditorActionListener, View.OnClickListener {
    ...
    private TextView mTvNewuserSms;
